...
public final class ModelGenerateSupport {
	...
	public static void generatePOJOModel(String pdmPath, String savePath) throws Exception {
		generateModel(pdmPath, savePath, pojoModelGenerator);
	}

	public static void generateMapModel(String pdmPath, String savePath) throws Exception {
		generateModel(pdmPath, savePath, mapModelGenerator);
	}

	private static void generateModel(String pdmPath, String savePath, ModelGenerator modelGenerator) throws Exception {
